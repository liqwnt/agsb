...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "liqwnt"         # 用户名
UUID = "95c21394-06b5-4969-a2e4-f1fd0eae7b8c"                     # UUID，留空则自动生成
PORT = 49998                   # Vmess端口，留空或0则自动生成
DOMAIN = "strea.qqii.eu.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNDQ1ZDU2NDc1ZGJiOGRhMzM1OWMxNjE0MGEzMjJmMTEiLCJ0IjoiMGM1MzZjNDMtZWRjMy00NGYxLTkzOGUtNmUwZTBhZDFhY2NlIiwicyI6Ik5tWTNaakpsT0RBdFlqSTNaaTAwT0RreUxUaG1NRFl0TW1JNE9UbGhNR0kyTkRKbSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
